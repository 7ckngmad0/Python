...
class travel:
    ...
    def __init__(self,root):
        self.root = root
        self.root.title("Taxi Booking System ni JM HAHJAJA:>")
        ...
        Lamboghini=StringVar()
        Maseratti=StringVar()
        Koenigsegg=StringVar()
    ...
    #This for the functions
        ...
        def Reset():
            ...
            self.txtLamboghini.configure(state=DISABLED)
            self.txtMaseratti.configure(state=DISABLED)
            self.txtKoenigsegg.configure(state=DISABLED)
        ...
        def Receiptt():
            if reset_counter is 0 and Firstname.get()!="" and Surname.get()!="" and Address.get()!="" and Postcode.get()!="" and Mobile.get()!="" and Telephone.get()!="" and Email.get()!="":
                ...
                self.txtReceipt1.insert(END,'Lamboghini:\n')
                self.txtReceipt2.insert(END, Lamboghini.get() + "\n")
                self.txtReceipt1.insert(END,'Prime Sedan:\n')
                self.txtReceipt2.insert(END, Maseratti.get() + "\n")
                self.txtReceipt1.insert(END,'Premium Sedan:\n')
                self.txtReceipt2.insert(END, Koenigsegg.get() + "\n")
        ...
        def selectCar():
            ...
            if carType.get() == 1:
                ...
                self.txtKoenigsegg.configure(state = DISABLED)
                Koenigsegg.set("0")
                self.txtLamboghini.configure(state = NORMAL)
                Item5 = float(8)
                Lamboghini.set("P "+ str(Item5))
            elif carType.get() == 2:
                self.txtLamboghini.configure(state =DISABLED)
                Lamboghini.set("0")
                self.txtKoenigsegg.configure(state = DISABLED)
                Koenigsegg.set("0")
                self.txtMaseratti.configure(state = NORMAL)
                Item5 = float(10)
                Maseratti.set("P "+ str(Item5))
            else:
                self.txtLamboghini.configure(state =DISABLED)
                Lamboghini.set("0")
                self.txtMaseratti.configure(state = DISABLED)
                Maseratti.set("0")
                self.txtKoenigsegg.configure(state = NORMAL)
                Item5 = float(15)
                Koenigsegg.set("P "+ str(Item5))
        ...
        def Total_Paid():
            if ((var1.get() == 1 and var2.get() == 1 and var3.get() == 1 or var4.get() == 1) and carType.get() != 0 and journeyType.get() != 0 and (varl1.get() != "" and varl2.get() !="")):
                if journeyType.get()==1:
                    ...
                    Tax = "P " + str('%.2f'%((Cost_of_fare) *0.09))
                    ST = "P " + str('%.2f'%((Cost_of_fare)))
                    TT = "P " + str('%.2f'%(Cost_of_fare+((Cost_of_fare)*0.9)))
   ...
   #================================================mainframe========================================================================
        ...
        self.lblTitle=Label(Tops,font=('arial',70,'bold'),text=" TaxiBookingSystem ni JM :> ")
        self.lblTitle.grid()
    ...
    #===============================================Taxi Information==============================================================
        ...
        self.cboPickup['value']=('','Robinsons Magnolia','PUP-Main','SM Sta. Mesa','LRT-Station', 'Sa bahay namin')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('','PUP-Main','Robinsons Magnolia','SM Sta. Mesa', 'Sa bahay namin', 'Sa puso ko')
        self.cboDrop.current(0)
    ...
    #==========================================================taxiselect=======================================================================
        ...
        self.chkLamboghini=Radiobutton(Book_Frame,text="Lamboghini",value=1,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=0, column=0, sticky=W)
        self.txtLamboghini = Label(Book_Frame,font=('arial',14,'bold'),width =7,textvariable=Lamboghini,bd=5, state= DISABLED, justify=RIGHT,bg="white",relief=SUNKEN)
        self.txtLamboghini.grid(row=0,column=1)
        

        self.chkMaseratti=Radiobutton(Book_Frame,text="Maseratti",value=2,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=1, column=0, sticky=W)
        self.txtMaseratti= Label(Book_Frame,font=('arial',14,'bold'),width =7,textvariable=Maseratti,bd=5, state= DISABLED, justify=RIGHT,bg="white",relief=SUNKEN)
        self.txtMaseratti.grid(row=1,column=1)
             
       
        self.chkKoenigsegg = Radiobutton(Book_Frame,text="Koenigsegg",value=3,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=2, column=0, sticky=W)
        self.txtKoenigsegg = Label(Book_Frame,font=('arial',14,'bold'),width =7,textvariable=Koenigsegg,bd=5, state= DISABLED, justify=RIGHT,bg="white",relief=SUNKEN)
        self.txtKoenigsegg.grid(row=2,column=1)
